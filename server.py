...
# ★ 設定區 — 只需修改這裡
# ================================================================
GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY', 'AIzaSyD1_XoGFpfn8MWtf0olIGaL5ml9Ar3WzwE')
...
【台灣廣告法規重點（供法規合規檢查用）】
1. 食品安全衛生管理法第28條：食品廣告不得有不實、誇張或易生誤解之情形；食品不得為醫療效能之標示或廣告（如：治療、改善、預防疾病、降血糖、抗癌等詞句）。
2. 化粧品衛生安全管理法第10條：化粧品廣告不得虛偽或誇大；不得宣稱醫療效能（如：除疤、換膚、治療痘疤、消炎等）。
3. 醫療器材管理法第46條：非醫療器材不得宣稱醫療效能（如：治療關節炎、改善視力等）。
4. 藥事法第69條：非藥物不得宣稱醫療效能。
5. 健康食品管理法第14條：健康食品廣告不得超過許可範圍，不得涉及醫療效能。
6. 公平交易法第21條：廣告不得虛偽不實或引人錯誤，比較廣告須有佐證資料。
7. 常見違規詞句範例：「治療」「改善」「預防疾病」「降血壓」「抗癌」「補腎」「消炎」「換膚」「除疤」「醫美級」「保證有效」「100%」等。

{
  ...
  "compliance": "根據台灣食品安全衛生管理法第28條、化粧品衛生安全管理法第10條、醫療器材管理法第46條、藥事法第69條，條列影片中可能涉及違規的畫面、字幕、旁白內容，並提供修正建議。若無違規疑慮則填寫：本影片未發現明顯法規違規疑慮。格式：1.【違規疑慮】違規內容描述→【修正建議】具體修改方向\n2...."
}
